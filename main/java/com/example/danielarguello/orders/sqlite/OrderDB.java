...
public class OrderDB extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY" +
                        " AUTOINCREMENT, %s TEXT NOT NULL UNIQUE, %s TEXT NOT NULL,%s TEXT NOT NULL)",
                Tables.APP, BaseColumns._ID,
                OrderContract.Apps.ID,
                OrderContract.Apps.TITLE,
                OrderContract.Apps.DESCRIPTION));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+Tables.APP);
